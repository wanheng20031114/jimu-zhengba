...
当前版本 **0.7.5**，变化与验收见 [交付记录](docs/release-0.7.5.md)。
...
- 近战/远程护甲与类别附伤统一计算。剑士45金币，近甲2/远甲1，基础攻击20、对骑兵+20；骑士80金币，近甲2/远甲4，基础攻击19、对弓手+11、对攻城器+31，无科技两次击杀弓手、四次击杀任一种攻城器；弓手基础攻击12、无类别附伤，对骑士每箭8点、需15箭，对剑士每箭11点、需10箭。骑士对剑士仍需6次、剑士对骑士每刀38点、4次。
