...
当前热修发行版 **0.11.0.1**，协议 **10**：修复含Bot对局约35秒被误踢、网络错误误报超时；Relay扩为8房，每房最多8名真人。网络兼容标识及内容清单保持0.11.0协议10不变，原协议10发行包也可连接已修复中继。详见 [联机热修报告](report/network-hotfix-0.11.0.1.md)。
