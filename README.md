...
当前版本 **0.11.0**，协议 **9**：剑士、投石车、加农炮视野统一为14，弓手7秒训练、骑士8秒训练；炮基础攻击40，仅对建筑增加100伤害。详见 [完整数值审查](report/balance-0.11.0.md)，报告以0.10.0为基线，列出全部单位对位、攻防科技组合及训练与视野变化。联机双方和中继必须使用相同版本。
...
- 剑士100生命、近甲2/远甲0、攻击8、对骑兵+14；弓手60生命、近甲0/远甲3、攻击12、无类别加成；骑士120生命、近甲2/远甲6、攻击9、对弓手+3/攻城器+11。三者视野分别14/14/16，攻击间隔1.2/1.5/1.1秒。无科技且不治疗时，剑士→骑士每击20、6击，弓手→剑士每箭12、9箭，骑士→弓手每击12、5击；骑兵切弓手、弓手远程压制剑士、剑士对抗骑兵，实际胜负仍受距离、齐射和包围影响。农民150生命、双甲0、攻击5、1.3秒间隔、视野9。
- 投石车200金币、140生命、近甲0/远甲2、射程13/最小3、18基础范围伤害，对剑士+6、建筑+50，攻击间隔3秒；半径3内均匀满伤、无友军伤害，发射后落点固定。无科技对剑士24、弓手15，分别需5击/4击；任意攻防科技组合下两者都至少4击。加农炮250金币、180生命、近甲0/远甲2、射程13/最小2.5、40基础单体伤害，仅对建筑+100，没有攻城器类别附伤，3.2秒间隔；无科技对建筑130、同款炮38，同款需5炮，双方同级攻防科技仍需5炮。投石车/加农炮视野均为14。
