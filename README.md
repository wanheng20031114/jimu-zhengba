...
当前版本 **0.11.0**，协议 **10**：剑士、投石车、加农炮视野统一为14，弓手7秒训练、骑士8秒训练；炮基础攻击40，仅对建筑增加100伤害。详见 [完整数值审查](report/balance-0.11.0.md)，报告以0.10.0为基线，列出全部单位对位、攻防科技组合及训练与视野变化。联机双方和中继必须使用相同版本；电脑难度随席位配置同步，旧协议中继不能接入。
...
- 大本营只训练农民：50 金币、10 秒，存活与排队合计基础上限10。学院一次性研究“农民上限扩展”，125金币、24秒，完成后仅该玩家上限提升至12，Bot同样需要付费研究。兵营训练剑士45金币/6秒、弓手60金币/7秒、骑士80金币/8秒；军工厂训练投石车与加农炮各20秒。军事人口基础50，可在学院升至75/100，每级500金币、30秒；剑士、弓手、骑士各占1，攻城器占3，训练中预留的人口计入上限。
...
- 剑士100生命、近甲2/远甲1、攻击8、对骑兵+14；弓手60生命、近甲0/远甲5、攻击11、无类别加成；骑士（骑兵类别）120生命、近甲2/远甲7、攻击9、对弓手+3/攻城器+11。三者视野分别14/14/16，攻击间隔1.2/1.5/1.1秒。无科技且不治疗时，剑士→骑士每击20、6击，弓手→剑士每箭10、10箭，弓手→骑士每箭4、30箭，骑士→弓手每击12、5击；骑兵切弓手、弓手远程压制剑士、剑士对抗骑兵，实际胜负仍受距离、齐射和包围影响。农民150生命、双甲0、攻击5、1.3秒间隔、视野9。
- 投石车200金币、140生命、近甲0/远甲2、射程13/最小3、18基础范围伤害，对剑士+6、建筑+50，攻击间隔3秒；半径3内均匀满伤、无友军伤害，发射后落点固定。无科技对剑士23、弓手13，均需5击；任意攻防科技组合下两者都至少4击。加农炮250金币、180生命、近甲0/远甲2、射程13/最小2.5、40基础单体伤害，仅对建筑+100，没有攻城器类别附伤，3.2秒间隔；无科技对建筑130、同款炮38，同款需5炮，双方同级攻防科技仍需5炮。投石车/加农炮视野均为14。
...
- 防御塔20秒施工、1000生命、近甲10/远甲10、射程13，基础远程攻击16、对剑士+3/骑兵+9，1.5秒间隔；无科技对剑士18、弓手11、骑士18，自动攻击且无法驻军。大本营3000生命、双甲10、攻击40、射程10、2秒间隔；兵营/军工厂/学院生命1500/1800/1400、双甲10，均不享受军事攻防科技。旧地图的赤旗要塞同为40攻击，弩箭哨塔由14提高至17攻击。
