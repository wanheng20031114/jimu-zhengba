...
Godot 4.6 原创 3D RTS，采用暖色低多边形模型与 45° 正交视角。快速建立兵营，指挥混编军队，争夺金矿并摧毁敌方基地。支持单人对 Bot、1v1、2v2、3v3、2v2v2 三队混战和六人无队伍乱斗，通过上海 ENet/DTLS 中继联机。
...
当前版本 **0.8.0**，变化与验收见 [交付记录](docs/release-0.8.0.md)。
...
- 1v1 琥珀十字路（96×96）、2v2 双谷争锋（128×112）；新增 3v3 三线烽火（160×144）、2v2v2 三盟盆地（176×176）、乱斗落冠荒原（160×160）。各有独立原生地图，对称出生与永久矿脉。
- 房间最多六名真人，空位可用 Bot 补齐；3v3 每队三人，2v2v2 每队两人，乱斗每人独立阵营。调整队伍后，出生位置随队伍排列，队友相邻。
- 自己蓝色、队友黄色、所有敌人红色；仅同队共享视野。摧毁某方全部军事建筑即淘汰该方，其余各方继续对局，直到只剩最后一方。房主被淘汰仍继续主持比赛。
- 每人开局 1 座大本营、1 座守护左侧出生矿的已完工弓箭塔、3 农民、320 金币。开局塔免费，全部五种模式的真人与 Bot 均有一座，1000 生命，计入清建筑胜负。自然收入每秒 1，采矿每人每 3 秒 +4；每处矿脉共享 6 个位置，额外农民等待空位。
...
- 近战/远程护甲与类别附伤统一计算。剑士45金币，近甲2/远甲1，基础攻击20、对骑兵+40；骑士80金币，近甲2/远甲4，基础攻击19、对弓手+11、对攻城器+31，无科技两次击杀弓手、四次击杀任一种攻城器；弓手基础攻击12、无类别附伤，对骑士每箭8点、需15箭，对剑士每箭11点、需10箭。骑士对剑士仍需6次、剑士对骑士每刀58点、3次。
- 投石车200金币、160生命、13射程、35基础范围伤害，对剑士+45、弓手+15、建筑+50，无科技中心命中剑士79/弓手50；加农炮250金币、200生命、14射程、86基础单体伤害，仅对建筑+150。无科技对建筑分别75/226，炮互射每击80，两击后剩40/200生命。箭塔射程14，与炮相同。两种攻城器近甲固定0，防御科技只增加其远甲；最小射程仍分别3/2.5，攻击间隔3/3.2秒，训练各20秒。
