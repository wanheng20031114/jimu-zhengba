...
def main() -> int:
    ...
    elif args.suite not in ("game", "expiry", "commands", "six-codec", "empty-slots"):
    ...
    if args.suite not in ("game", "expiry", "commands", "six-codec", "empty-slots"):
