...
var _previews: Node
const KINDS: Array[String] = ["swordsman", "shield_guard", "spearman", "archer", "knight", "catapult", "cannon", "farmer", "headquarters", "gold_vein", "defense_tower"]
...
func _check_recolor_switches() -> void:
	...
	for relation: int in [FactionPalette.ENEMY, FactionPalette.ALLY]:
		for pair: Array in [["swordsman", "barracks"], ["shield_guard", "barracks"], ["archer", "barracks"], ["knight", "barracks"],
