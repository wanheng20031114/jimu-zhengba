...
const UNIT_ORDER := ["swordsman", "spearman", "archer", "knight", "catapult", "cannon", "farmer"]
const UNIT_NAMES := ["剑士", "长矛兵", "弓箭手", "骑士", "投石车", "加农炮", "农民"]
