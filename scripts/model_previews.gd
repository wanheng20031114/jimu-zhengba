...
const KINDS: Array[String] = ["swordsman", "shield_guard", "spearman", "archer", "knight", "war_elephant", "light_cavalry", "catapult", "cannon", "farmer", "headquarters", "gold_vein", "defense_tower", "barracks", "factory", "academy"]
...
func _ready() -> void:
	for kind: String in KINDS:
		...
		if kind in ["swordsman", "shield_guard", "spearman", "archer", "knight", "war_elephant", "light_cavalry", "catapult", "cannon", "farmer"]:
			model.set_team(0)
