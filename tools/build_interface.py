...
label('Income','Resources','基础 +1/秒',104,41,75,21,11,'Color(0.69,0.66,0.51,1)')
label('ArmyCaption','Resources','人口',204,8,115,22,12,'Color(0.67,0.77,0.8,1)')
...
label('Economy','HelpOverlay/Paper','U 招募农民 · 右键矿脉采集 · V 建塔（Shift 连续）· Delete 取消工地 · . 空闲农民',36,523,670,28,11,'Color(0.65,0.70,0.65,1)')
...
m.node('CameraRig','Node3D','.',position='Vector3(-16,0,21)',script='ExtResource("camera")')
m.node('Camera3D','Camera3D','CameraRig',position='Vector3(-29.698485,42,29.698485)',rotation_degrees='Vector3(-45,-45,0)',projection='1',size='31.0',near='0.1',far='220.0',current='true')
